  ...
  <nav class="navbar navbar-inverse navbar-static-top">
    ...
    <div class="topnav">
      <div class="btn-toolbar">
        ...
        <div class="btn-group">
          <a href="auth/destroy" data-toggle="tooltip" data-original-title="Logout" data-placement="bottom" class="btn btn-metis-1 btn-sm">
  ...
  <div class="media user-media">
    ...
    <div class="user-wrapper">
      <a class="user-link" href="">
        <img class="media-object img-thumbnail user-img" alt="User Picture" width="75px" height="75px" src="assets/img/{useravatar}">
      </a> 
      <div class="media-body">
        ...
        <ul class="list-unstyled user-info">
          ...
          <li>Last Login :
            <br>
            <small>
              <i class="fa fa-calendar"></i>&nbsp;{userlastlogin}</small> 
          </li>
        </ul>
      </div>
    </div>
