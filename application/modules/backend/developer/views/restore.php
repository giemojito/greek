		...
		<!-- <div class="box"> -->
			<?php if (isset($results) && ! empty($results)) : ?>
				...
				<div style="text-align: right; margin-bottom: 10px;">
					<?php echo anchor('/developer/databases/backups', 'Back to Database Tools'); ?>
				</div>
			...
			<?php else : ?>
				<?php echo form_open($this->uri->uri_string()); ?>
					...
					<div class="form-actions">
						<input type="submit" name="restore" class="btn btn-primary" value="Restore" /> OR 
						<?php echo anchor('/developer/databases/backups', 'Cancel'); ?>
					</div>
					<br>
				<?php echo form_close(); ?>
			<?php endif; ?>
