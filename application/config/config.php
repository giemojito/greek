...
|
*/
$config['encryption_key'] = 'gr33k1ng-s0lut10ns';
...
|
*/
$config['sess_cookie_name']		= 'greek';
$config['sess_expiration']		= 7200;
$config['sess_expire_on_close']	= TRUE;
$config['sess_encrypt_cookie']	= TRUE;
$config['sess_use_database']	= TRUE;
$config['sess_table_name']		= 'greeksession';
...
| 	APPPATH.'widgets/' => '../modules/',
| 	APPPATH.'widgets/' => '../widgets/',
| 	APPPATH.'apps/' => '../apps/',
| );
| always use trailing / and separate by comma if multiple locations
|
*/
$config['modules_locations'] = array(
